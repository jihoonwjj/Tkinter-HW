...
jangiha = pygame.mixer.Sound("bgms\장기하와 얼굴들 - 풍문으로 들었소 가사 (Synced Lyrics).wav")
duckply = pygame.mixer.Sound("bgms\체리필터 (cherryfilter) - 오리 날다 [가사 Lyrics].wav")
seeyouagain = pygame.mixer.Sound("bgms\Wiz Khalifa - See You Again ft. Charlie Puth [Official Video] Furious 7 Soundtrack.wav")
homealone = pygame.mixer.Sound("bgms\나홀로집에 Home Alone OST - Somewhere in My Memory [가사해석 번역].wav")
jojoost = pygame.mixer.Sound("bgms\Giornos Theme best part but perfect ending.wavg")
